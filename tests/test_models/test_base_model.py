...
class TestBasemodel(unittest.TestCase):
    ...
    def setUp(self):
        """Performing some operations before the tests are run"""
        pass

    def tearDown(self):
        """Performing some operations after the tests are run"""
        try:
            os.remove('file.json')
        except Exception:
            pass
    ...
    def test_default(self):
        """Testing the type of value stored"""
        i = self.value()
        self.assertEqual(type(i), self.value)

    def test_kwargs(self):
        """Testing kwargs with an int"""
        i = self.value()
        copy = i.to_dict()
        new = BaseModel(**copy)
    ...
    def test_save(self):
        """Testing the save function of the BaseModel class"""
        i = self.value()
        i.save()
        key = self.name + "." + i.id
    ...
    def test_str(self):
        """Testing the __str__ function of the BaseModel class"""
        i = self.value()
    ...
    def test_kwargs_none(self):
        """Testing kwargs that is empty"""
        n = {None: None}
        with self.assertRaises(TypeError):
            new = self.value(**n)

    def test_kwargs_one(self):
        """Testing kwargs with one key-value pair"""
        n = {'Name': 'test'}
        new = self.value(**n)
    ...
    def test_created_at(self):
        """Testing the type of created_at"""
        new = self.value()
        self.assertEqual(type(new.created_at), datetime)

    def test_updated_at(self):
        """Testing the type of updated_at"""
        new = self.value()
    ...
    def test_delete(self):
        """Testing the delete function of the BaseModel class"""
